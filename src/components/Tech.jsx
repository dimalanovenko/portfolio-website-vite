...
const Tech = () => {
    ...
    return (
        ...
        >
            ...
            >
                <motion.ul
                    className='grid grid-cols-4 gap-21'
                >
                    <motion.li
                        ...
                        relative cursor-pointer rounded-xl w-[200px] h-[100px] flex items-center justify-center`}
                    >
                        {!flipped.rotateReact ?
                            <FaReact
                                className='absolute text-[#61dafb] h-10 w-10'
                            />
                            :
                            <motion.h1
                                initial={{
                                ...
                                className={`text-xl ${theme === 'dark' ? 'text-white' : 'text-zinc-800'}`}>
                                react
                            </motion.h1>
                        }
                    </motion.li>
                    ...
                    >
                        {!flipped.rotateJs ?
                            <FaJsSquare
                                className='absolute text-yellow-500 h-10 w-10'
                            />
                            :
                            <motion.h1
                                initial={{
                    ...
                    >
                        {!flipped.rotateHtml ?
                            <FaHtml5
                                className='absolute text-[#e5532d] h-10 w-10'
                            />
                            :
                            <motion.h1
                                initial={{
                    ...
                    >
                        {!flipped.rotateCss ?
                            <FaCss3Alt
                                className='absolute text-[#1471b5] h-10 w-10'
                            />
                            :
                            <motion.h1
                                initial={{
                    ...
                    >
                        {!flipped.rotateTailwind ?
                            <RiTailwindCssFill
                                className='absolute text-[#39b5f3] h-10 w-10'
                            />
                            :
                            <motion.h1
                                initial={{
                    ...
                    >
                        {!flipped.rotateSass ?
                            <SiSass
                                className='absolute text-[#c46494] h-10 w-10'
                            />
                            :
                            <motion.h1
                                initial={{
                    ...
                    >
                        {!flipped.rotateGit ?
                            <FaGitAlt
                                className='text-[#f15233] h-10 w-10'
                            />
                            :
                            <motion.h1
                                initial={{
                    ...
                    >
                        {!flipped.rotateBash ?
                            <SiGnubash
                                className={`h-10 w-10 ${theme === 'dark' ? 'text-white' : 'text-zinc-800'}`}
                            />
                            :
                            <motion.h1
                                initial={{
